...
import com.vitalite.vitalite.controlleurs.errors.BadRequestAlertException;
import com.vitalite.vitalite.controlleurs.errors.EmailAlreadyUsedException;
import com.vitalite.vitalite.controlleurs.errors.LoginAlreadyUsedException;
...
public class UserResource {
    ...
    public ResponseEntity<User> createUser(@Valid @RequestBody UserDTO userDTO) throws URISyntaxException {
        ...
        /* } else if (userRepository.findOneByEmail(userDTO.getLogin().toLowerCase()).isPresent()) {
    ...
    public ResponseEntity<UserDTO> updateUser(@Valid @RequestBody UserDTO userDTO) {
        ...
        existingUser = userRepository.findOneByEmail(userDTO.getLogin().toLowerCase());
        if (existingUser.isPresent() && (!existingUser.get().getId().equals(userDTO.getId()))) {
            throw new LoginAlreadyUsedException();
        }
    ...
    public ResponseEntity<UserDTO> getUser(@PathVariable String login) {
        ...
        return new ResponseEntity<>(userService.getUserWithAuthoritiesByLogin(login)
        .map(us->mapper.map(us,UserDTO.class)).get(), HttpStatus.CREATED);
    }
